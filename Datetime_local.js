 ...
 */
Datetime_local.parseISODate = function (dateString) {
 ...
 */
Datetime_local.zeroms = function () {
 ...
 */
Datetime_local.parse = function (dateString, this_parserOnly = true) {
    if (dateString === undefined)
        return NaN;
    dateString = String(dateString).toLowerCase().trim();
    const regexArray = Datetime_local.parseISODate(dateString), currentDate = new Date, currentTime = new Date(currentDate);
    ...
    if (/today\s*\(?utc\)?/i.test(dateString)) {
    ...
    let regexpArray = /^(next|last|previouse?) ([a-z]+)/.exec(dateString);
    if (regexpArray) {
    ...
    if (regexpArray) {
        return +new Date(Number(regexpArray[3]), monthNames.indexOf(regexpArray[2]), Number(regexpArray[1]), Number(regexpArray[4]), Number(regexpArray[5]), Number(regexpArray[6]));
    }
    ...
    if (regexpArray) {
        return +new Date(Number(regexpArray[3]), monthNames.indexOf(regexpArray[1].toLowerCase()), Number(regexpArray[2]), Number(regexpArray[4]), Number(regexpArray[5]), Number(regexpArray[6]));
    }
    ...
    if (regexpArray) {
        ...
        if (leftSeperator !== riteSeperator)
            return NaN;
        if (leftSeperator === '/') {
            [date, month] = [month, date];
        }
        return +new Date(Number(year), Number(month) - 1, Number(date), Number(hour ?? 0), Number(minute ?? 0), Number(second ?? 0));
    }
 ...
 */
Datetime_local.prototype[Symbol.toPrimitive] = function (hint) {
    switch (String(hint)) {
        case 'string':
 ...
 * @returns {string}
 */
Datetime_local.prototype.format = function (format) {
 ...
 */
Datetime_local.prototype.toString = function () {
 ...
 */
Datetime_local.prototype.valueOf = function () {
 ...
 * @returns {number} the number of milliseconds this object contains since the epoch
 */
Datetime_local.prototype.getTime = function () {
    return this.date.getTime();
};
/**
 ...
 * @returns {number}
 */
Datetime_local.prototype.setTime = function (timestamp) {
    return this.date.setTime(timestamp);
};
Datetime_local.prototype.getComponents = function () {
    return [this.getYear(), this.getMonth(), this.getDate(), this.getHours(), this.getMinutes(), this.getSeconds(), this.getMilliseconds(),];
};
Datetime_local.prototype.toHTMLDatetime_local = function () {
 ...
 * @returns {number}
 */
Datetime_local.prototype.getDay = function () {
 ...
 * @returns {number}
 */
Datetime_local.prototype.getYear = function () {
 ...
 * @returns {number}
 */
Datetime_local.prototype.getFullYear = function () {
 ...
 * @returns {number}
 */
Datetime_local.prototype.getMonth = function () {
 ...
 * @returns {number}
 */
Datetime_local.prototype.getDate = function () {
 ...
 * @returns {number}
 */
Datetime_local.prototype.getHours = function () {
 ...
 * @returns {number}
 */
Datetime_local.prototype.getMinutes = function () {
 ...
 * @returns {number}
 */
Datetime_local.prototype.getSeconds = function () {
 ...
 * @returns {number}
 */
Datetime_local.prototype.getMilliseconds = function () {
 ...
 * @returns {number}
 */
Datetime_local.prototype.getUTCDay = function () {
 ...
 * @returns {number}
 */
Datetime_local.prototype.getUTCYear = function () {
 ...
 * @returns {number}
 */
Datetime_local.prototype.getUTCFullYear = function () {
 ...
 * @returns {number}
 */
Datetime_local.prototype.getUTCMonth = function () {
 ...
 * @returns {number}
 */
Datetime_local.prototype.getUTCDate = function () {
 ...
 * @returns {number}
 */
Datetime_local.prototype.getUTCHours = function () {
 ...
 * @returns {number}
 */
Datetime_local.prototype.getUTCMinutes = function () {
 ...
 * @returns {number}
 */
Datetime_local.prototype.getUTCSeconds = function () {
 ...
 * @returns {number}
 */
Datetime_local.prototype.getUTCMilliseconds = function () {
 ...
 * @returns {number}
 */
Datetime_local.prototype.getTimezoneOffset = function () {
 ...
 * @returns {number}
 */
Datetime_local.prototype.getDayNumberWeek = function () {
    return this.date.getDay();
};
/**
 * a proxy for `Date.prototype.getDate`
 * @returns {number}
 */
Datetime_local.prototype.getDayNumberMonth = function () {
    return this.date.getDate();
};
/**
 * a proxy for `Date.prototype.getDate`
 * @returns {number}
 */
Datetime_local.prototype.getDayNumber = function () {
    return this.date.getDate();
};
/**
 ...
 */
Datetime_local.prototype.getDayName = function () {
 ...
 */
Datetime_local.prototype.getMonthName = function () {
 ...
 */
Datetime_local.prototype.getFullDayName = function () {
 ...
 */
Datetime_local.prototype.getFullMonthName = function () {
 ...
 */
Datetime_local.prototype.setYear = function (year) {
 ...
 * @returns {number} the new timestamp the date object holds
 */
Datetime_local.prototype.setFullYear = function (fullYear, month, date) {
 ...
 * @returns {number} the new timestamp the date object holds
 */
Datetime_local.prototype.setMonth = function (month, date) {
 ...
 * @returns {number} the new timestamp the date object holds
 */
Datetime_local.prototype.setDate = function (date) {
 ...
 * @returns {number} the new timestamp the date object holds
 */
Datetime_local.prototype.setHours = function (hours, minutes, seconds, milliseconds) {
 ...
 * @returns {number} the new timestamp the date object holds
 */
Datetime_local.prototype.setMinutes = function (minutes, seconds, milliseconds) {
 ...
 * @returns {number} the new timestamp the date object holds
 */
Datetime_local.prototype.setSeconds = function (seconds, milliseconds) {
 ...
 * @returns {number} the new timestamp the date object holds
 */
Datetime_local.prototype.setMilliseconds = function (milliseconds) {
 ...
 * @returns {number} the new timestamp the date object holds
 */
Datetime_local.prototype.setUTCYear = function (year) {
    year = +year; // let it throw on bigint
    const fullYear = year >= 0 && year < 100 ? year + 1900 : year;
 ...
 * @returns {number} the new timestamp the date object holds
 */
Datetime_local.prototype.setUTCFullYear = function (fullYear, month, date) {
 ...
 * @returns {number} the new timestamp the date object holds
 */
Datetime_local.prototype.setUTCMonth = function (month, date) {
 ...
 * @returns {number} the new timestamp the date object holds
 */
Datetime_local.prototype.setUTCDate = function (date) {
 ...
 * @returns {number} the new timestamp the date object holds
 */
Datetime_local.prototype.setUTCHours = function (hours, minutes, seconds, milliseconds) {
    minutes = arguments.length > 1 ? minutes : this.getMinutes();
    seconds = arguments.length > 2 ? seconds : this.getSeconds();
    milliseconds = arguments.length > 3 ? milliseconds : this.getMilliseconds();
 ...
 * @returns {number} the new timestamp the date object holds
 */
Datetime_local.prototype.setUTCMinutes = function (minutes, seconds, milliseconds) {
    seconds = arguments.length > 1 ? seconds : this.getSeconds();
    milliseconds = arguments.length > 2 ? milliseconds : this.getMilliseconds();
 ...
 * @returns {number} the new timestamp the date object holds
 */
Datetime_local.prototype.setUTCSeconds = function (seconds, milliseconds) {
    milliseconds = arguments.length > 1 ? milliseconds : this.getMilliseconds();
 ...
 * @returns {number} the new timestamp the date object holds
 */
Datetime_local.prototype.setUTCMilliseconds = function (milliseconds) {
 ...
 * @returns {this}
 */
Datetime_local.prototype.addInterval = function (hours = null, minutes = null, seconds = null, months = null, days = null, years = null) {
    if (minutes !== null)
 ...
 * @param offset
 */
Datetime_local.getUTCOffset = function (offset) {
    if (isNaN(offset))
        return 'UTC+Error';
 ...
 */
Datetime_local.prototype.isValid = function () {
    // @ts-ignore
 ...
 */
Datetime_local.prototype.drawClock = function () {
    ...
    if (!$date.isValid())
        return `${svgString}</g>${end}`;
    const $i = (($date.getMilliseconds())), $s = ($date.getSeconds() * 6) + (($i / 1000) * 6), $m = ($date.getMinutes() * 6) + ($s / 60), $h = (($date.getHours() % 12) * 30) + ($date.getMinutes() / 2);
